...
fn main() {
    ...
    match subcommand.as_str() {
        ...
        "crop" => {
            ...
            // let (x, y, width, height) = if args.len() ==  { args } else { args };
            // crop(infile, outfile, amount);
        }
...
fn blur(infile: String, outfile: String, amount: String) {
    let amount: f32 = amount.parse::<f32>().unwrap_or(2.0);
...
fn brighten(infile: String, outfile: String, amount: String) {
    let amount = amount.parse::<i32>().unwrap_or(50);
